...
class ComentariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post comentarios_url, params: { comentario: { autor1: @comentario.autor1, comment: @comentario.comment, post_id: @comentario.post_id } }
    end
  ...
  test "should update comentario" do
    patch comentario_url(@comentario), params: { comentario: { autor1: @comentario.autor1, comment: @comentario.comment, post_id: @comentario.post_id } }
